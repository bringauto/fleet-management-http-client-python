# fleet-management-http-client-python.OrderApi
...
with fleet-management-http-client-python.ApiClient(configuration) as api_client:
    ...
    api_instance = fleet-management-http-client-python.OrderApi(api_client)
    order = fleet-management-http-client-python.Order() # Order | Order model in JSON format.
