# fleet-management-http-client-python.PlatformHWApi
...
with fleet-management-http-client-python.ApiClient(configuration) as api_client:
    ...
    api_instance = fleet-management-http-client-python.PlatformHWApi(api_client)
    platform_hw = fleet-management-http-client-python.PlatformHW() # PlatformHW | Platform HW model in JSON format.
