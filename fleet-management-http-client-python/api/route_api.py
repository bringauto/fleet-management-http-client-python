...
class RouteApi:
    ...
    def create_route(
        self,
        route: Annotated[Route, Field(description="Route model in JSON format.")],
        ...
        :param route: Route model in JSON format. (required)
        :type route: Route
    ...
    @validate_call
    def redefine_route_visualization(
        self,
        route_visualization: Annotated[RouteVisualization, Field(description="Route Visualization model in JSON format.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param route_visualization: Route Visualization model in JSON format. (required)
        :type route_visualization: RouteVisualization
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._redefine_route_visualization_serialize(
    ...
    @validate_call
    def redefine_route_visualization_with_http_info(
        self,
        route_visualization: Annotated[RouteVisualization, Field(description="Route Visualization model in JSON format.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def redefine_route_visualization_without_preload_content(
        self,
        route_visualization: Annotated[RouteVisualization, Field(description="Route Visualization model in JSON format.")],
        _request_timeout: Union[
            None,
    ...
    def _redefine_route_visualization_serialize(
        self,
        route_visualization,
        _request_auth,
        _content_type,
    ...
    def update_route(
        self,
        route: Annotated[Route, Field(description="JSON representation of the updated Route.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param route: JSON representation of the updated Route. (required)
        :type route: Route
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
