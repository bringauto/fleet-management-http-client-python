...
class Car(BaseModel):
    ...
    last_action_state: Optional[CarActionState] = Field(default=None, alias="lastActionState")
    __properties: ClassVar[List[str]] = ["id", "platformHwId", "name", "carAdminPhone", "defaultRouteId", "underTest", "lastState", "lastActionState"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_action_state
        if self.last_action_state:
            _dict['lastActionState'] = self.last_action_state.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastActionState": CarActionState.from_dict(obj["lastActionState"]) if obj.get("lastActionState") is not None else None
        })
        return _obj
