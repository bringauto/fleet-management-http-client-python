...
class Order(BaseModel):
    ...
    is_visible: Optional[StrictBool] = Field(default=True, alias="isVisible")
    __properties: ClassVar[List[str]] = ["id", "priority", "timestamp", "carId", "notification", "targetStopId", "stopRouteId", "notificationPhone", "lastState", "isVisible"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isVisible": obj.get("isVisible") if obj.get("isVisible") is not None else True
        })
        return _obj
